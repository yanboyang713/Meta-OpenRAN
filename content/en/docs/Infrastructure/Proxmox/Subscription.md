...
Now, Proxmox is great software; and developing great software takes great resources, great developers… and great money. As such, I encourage you to purchase a subscription if you’re using Proxmox in a business environment.
...
5. Step 5:
   Go to pve-enterprise.list file. comment out first line
5.  Step 6:
...
6.  Step 7: And when that’s done, run software upgrades!
